...
// // 获取球员的位置
// VecPosition WorldModel::getPosition(int playerId) {
//   return positions[playerId];
// }

// // 获取球员的角度
// SIM::AngDeg WorldModel::getAngle(int playerId) {
//   return angles[playerId];
// }

// // 获取球员的速度
// VecPosition WorldModel::getSpeed(int playerId) {
//   return speeds[playerId];
// }

// // 获取敌方球员的数量
// int WorldModel::getNumOpponents() {
//   return numOpponents;
// }

// // 更新敌方球员的数量
// void WorldModel::updateNumOpponents(int n) {
//   numOpponents = n;
// }
